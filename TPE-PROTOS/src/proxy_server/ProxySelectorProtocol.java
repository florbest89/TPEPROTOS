...
public class ProxySelectorProtocol implements TCPProtocol {
	...
	private void processEmail(ProxyAtt attachment) {
		...
		/*Deberia tener un metodo que sea para parsear el mail y que reciba un bytebuffer (el server read) y l33t y rotation para
		 * ir haciendo los cambios necesarios =)
		 * 
		 * Primero igual, que analice si el statuscode es -ERR porque siendo ese el caso me ahorro mucho. Si ese es el caso, cambio
		 * el flag del mail a false.
		 * 
		 * */
